class UsuarioDAO:
    ''' 
    DAO → Data Acess Object para la tabla de usuario
    ...
    def insertar(cls, usuario):
        with CursorDelPool() as cursor:
            ...
            valores = (usuarios.username, usuario.password)
    ...
    def actualizar(cls, usuario):
        with CursorDelPool() as cursor:
            ...
            valores = (usuarios.username, usuario.password, usuario.id_usuario)
...
if __name__ == '__main__':
    ...
    usarios = UsuarioDAO.seleccionar()
